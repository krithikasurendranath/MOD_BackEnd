...
namespace MOD.TrainingService.Migrations
{
    ...
    [Migration("20191122095715_mi1234")]
    partial class mi1234
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MOD.TrainingService.Models.Skills", b =>
                {
                    b.Property<int>("Sid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MOD.TrainingService.Models.Training", b =>
                {
                    ...
                    b.HasOne("MOD.TrainingService.Models.Skills", "Skills")
                        .WithMany()
                        .HasForeignKey("Sid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
